...
type FeatureColor = "blue" | "cyan" | "emerald" | "purple";
...
> = {
  blue: {
    ...
    iconWrapRing: "ring-1 ring-blue-500/20",
    iconColor: "text-blue-400",
  },
  cyan: {
    cardHoverBorder: "hover:border-cyan-500/30",
    cardHoverBg: "hover:bg-white/[0.04]",
    iconWrapBg: "bg-cyan-500/10",
    iconWrapRing: "ring-1 ring-cyan-500/20",
  ...
  emerald: {
    ...
    iconWrapRing: "ring-1 ring-emerald-500/20",
    iconColor: "text-emerald-400",
  },
  purple: {
    cardHoverBorder: "hover:border-purple-500/30",
    cardHoverBg: "hover:bg-white/[0.04]",
    iconWrapBg: "bg-purple-500/10",
    iconWrapRing: "ring-1 ring-purple-500/20",
          ...
          {features.map((feature) => {
            ...
            return (
              <Link
                ...
                href={feature.href}
                className={[
                  "group rounded-2xl border border-white/10 bg-white/[0.02] p-6 transition",
                  c.cardHoverBorder,
                  c.cardHoverBg,
                ].join(" ")}
              >
                <div className="flex items-start gap-4">
                  ...
                  >
                    <Icon className={["h-6 w-6", c.iconColor].join(" ")} />
                  </div>
